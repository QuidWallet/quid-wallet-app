...
class ImportPrivateKeyScreen extends React.Component {
    constructor(props) {
	super(props);
	...
	const { name, password, confirmPassword, privateKey } = this.state;
	const payload = {
	    name,
	    password,
	    confirmPassword,
...
export default connect(null, { generateKeystore })(ImportPrivateKeyScreen);
