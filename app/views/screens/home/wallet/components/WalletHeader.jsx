...
const TotalAssets = (totalBalance, currency, isBalanceHidden, toggleHiddenBalance) => {
...
class HeaderContent extends React.PureComponent {
	...
	return (
	    <View style={{flex: 1}}>
	      { TotalAssets(totalBalance, currency, isBalanceHidden, toggleHiddenBalance) }
...
const mapStateToProps = state => ({
    ...
    totalBalance: getAssetsBalance(state),
